...
title = "EUMETNET OPERA: March 2017"
fstr = 'RAVI_OPERA'

COUNTRIES="IS,NO,SE,FI,EE,LV,PL,DK,GB,JE,IE,NL,BE,ES,PT,FR,DE,CH,HU,CZ,SK,SI,HR,RS,RO,MT" 
...
m.drawmeridians(np.arange(Round(x1,False),Round(x2,False),10),labels=[0,0,0,1],
                color='black',linewidth=0.2)
m.drawparallels(np.arange(Round(y1,False),Round(y2)+10,10),labels=[1,0,0,0],
                color='black',linewidth=0.2)
m.shadedrelief()
